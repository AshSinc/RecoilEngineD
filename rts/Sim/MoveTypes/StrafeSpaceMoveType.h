...
#ifndef STRAFE_SPACE_MOVE_TYPE_H_
#define STRAFE_SPACE_MOVE_TYPE_H_
 ...
 */
class StrafeSpaceMoveType: public ASpaceMoveType
{
	CR_DECLARE_DERIVED(StrafeSpaceMoveType)
...
public:
	...
	StrafeSpaceMoveType(CUnit* owner);
